...
-- | The undefined value.
foreign import undefined ∷ ∀ a. Undefinable a

foreign import undefinable ∷ ∀ a r. Fn3 (Undefinable a) r (a → r) r

-- | Wrap a non-undefined value.
foreign import notUndefined ∷ ∀ a. a → Undefinable a

-- | Takes `Nothing` to `undefined`, and `Just a` to `a`.
toUndefinable ∷ ∀ a. Maybe a → Undefinable a
toUndefinable = maybe undefined notUndefined

-- | Represent `undefined` using `Maybe a` as `Nothing`.
toMaybe ∷ ∀ a. Undefinable a → Maybe a
